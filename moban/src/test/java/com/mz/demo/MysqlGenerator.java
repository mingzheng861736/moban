...
public class MysqlGenerator {
    ...
    private static String authorName = "weishilei";     //作者
    private static String[] table = {"ums_admin", "sys_menu", "sys_role", "sys_role_menu", "sys_user_role"};             //table名字
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir(path + "/bar-admin/src/main/java")//输出目录
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://192.168.1.166:3306/bar?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.zfl.bar.admin")// 自定义包路径
                ...
                new InjectionConfig() {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        return path+"/bar-admin/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
                    }
                }))
       ).setTemplate(
